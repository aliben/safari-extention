...
if (typeof self.nacl === 'undefined') {
    if (typeof self.importScripts === 'function') {
        try {
            ...
            self.importScripts('./lib/nacl-shim.js');
            self.importScripts('./native-bridge.js');
        } catch (e) {
            console.warn('importScripts failed:', e.message);
        }
    }
}
// If nacl ended up on module.exports (CJS detection), hoist it to self
if (typeof self.nacl === 'undefined' && typeof module !== 'undefined' && module.exports && module.exports.secretbox) {
    self.nacl = module.exports;
}
if (typeof nacl === 'undefined' && typeof self.nacl !== 'undefined') {
    // make bare `nacl` references work
    var nacl = self.nacl;
}
if (typeof nacl === 'undefined') {
    console.error('CRITICAL: tweetnacl (nacl) is not loaded. Encryption will not work.');
}
